...
public class Cosine_Similarity extends AppCompatActivity implements RecyclerViewInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cosine_similarity);
        ...
        DatabaseReference userRefYoung = rootRefYoung.child("Youngster_info");
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Cosine_Similarity.this, "Registration Failed"+error.toString(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onItemClick(int position) {
        Intent intent= new Intent (Cosine_Similarity.this,ExpandedCardView.class);
