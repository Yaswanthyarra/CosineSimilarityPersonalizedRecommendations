...
public class expanded_card_view_for_retired extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expanded_card_view_for_retired);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(installed){
                    ...
                    Toast.makeText(expanded_card_view_for_retired.this, "Whatsapp is not installed", Toast.LENGTH_SHORT).show();
                }
            }
        });

        btnrate=findViewById(R.id.button90);
        String rate=getIntent().getStringExtra("rate");
        String uid=getIntent().getStringExtra("uid");
        btnrate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent (expanded_card_view_for_retired.this,Rating_for_youngster.class);
