...
public class doyan_registration_career extends AppCompatActivity {
    ...
    private  DatabaseReference root=db.getReference().child("RetiredPeople_info");

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_doyan_registration_career);
        ...
        categories.add("Careers in Agriculture and Natural Resources");
        categories.add("Architecture and Construction Careers");
        categories.add("Careers in Arts and Communication");
        categories.add("Business Management and Administration Careers");
        categories.add("Finance Careers");
        categories.add("Government and Public Administration Careers");
        categories.add("Careers in Health Sciences");
        categories.add("Careers in Hospitality and Tourism");
        //style spinner
        ...
        categoriesE.add(0,"Duration of help:");
        ...
        categoriesP.add(0,"Minimum fees expected:");
        ...
        categoriesS.add(0,"Kind of service");
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                startActivity(new Intent(doyan_registration_career.this,doyen_login_page.class));
            }
        });
            ...
            mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(doyan_registration_career.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                        //Intent intent=new Intent(registration_page.this,retired_display_page.class);
                        // startActivity(intent);

                    }else{
                        progressDialog.dismiss();
                        Toast.makeText(doyan_registration_career.this, "Registration Failed"+task.getException(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
