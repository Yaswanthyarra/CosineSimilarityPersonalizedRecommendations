...
public class doyan_registration_it extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doyan_registration_it);
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                startActivity(new Intent(doyan_registration_it.this,doyen_login_page.class));
            }
        });
            ...
            mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(doyan_registration_it.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                        //Intent intent=new Intent(registration_page.this,retired_display_page.class);
                        // startActivity(intent);

                    }else{
                        progressDialog.dismiss();
                        Toast.makeText(doyan_registration_it.this, "Registration Failed"+task.getException(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
    ...
    private void sendUserToNextActivity() {
        Intent intent=new Intent(doyan_registration_it.this,youngster_login_page.class);
