...
public class young_registration_academic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_young_registration_academic);
        ...
        categoriesE.add(0,"Your current Standard");
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                startActivity(new Intent(young_registration_academic.this,youngster_login_page.class));
            }
        });
            ...
            mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(young_registration_academic.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                        //Intent intent=new Intent(registration_page.this,retired_display_page.class);
                        // startActivity(intent);

                    }else{
                        progressDialog.dismiss();
                        Toast.makeText(young_registration_academic.this, "Registration Failed"+task.getException(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
    ...
    private void sendUserToNextActivity() {
        Intent intent=new Intent(young_registration_academic.this,youngster_login_page.class);
