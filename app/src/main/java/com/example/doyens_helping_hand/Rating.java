...
public class
Rating extends AppCompatActivity {
    private float k;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        def = FirebaseDatabase.getInstance().getReference("RetiredPeople_info");
                ...
                public void onClick(View view) {
                    ...
                    def.child(uid).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(Rating.this, "successfully updated thank you for feedback " + Math.round(k), Toast.LENGTH_LONG).show();
                            Intent i = new Intent(Rating.this, Profile.class);
                            startActivity(i);
