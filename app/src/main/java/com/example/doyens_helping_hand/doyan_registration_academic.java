...
public class doyan_registration_academic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doyan_registration_academic);
        ...
        categoriesE.add(0,"Standard you wish to teach");
        categoriesE.add("1-5th standards");
        categoriesE.add("6-10 Standards");
        categoriesE.add("11-12 Standards");
        categoriesE.add("Graduation");
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                startActivity(new Intent(doyan_registration_academic.this,doyen_login_page.class));
            }
        });
            ...
            mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(doyan_registration_academic.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                        //Intent intent=new Intent(registration_page.this,retired_display_page.class);
                        // startActivity(intent);

                    }else{
                        progressDialog.dismiss();
                        Toast.makeText(doyan_registration_academic.this, "Registration Failed"+task.getException(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
