...
public class Domains_retired extends AppCompatActivity {
    private ImageButton btnacademic,btnit,btnsport,btncareer;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_domains_retired);
        btnacademic=findViewById(R.id.imageButton11);

        btnacademic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Domains_retired.this,doyan_registration_academic.class);
        ...
        btnit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Domains_retired.this,doyan_registration_it.class);
                startActivity(intent);
            }
        });
        ...
        btnsport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Domains_retired.this,doyan_registration_sport.class);
                startActivity(intent);
            }
        });
        ...
        btncareer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Domains_retired.this,doyan_registration_career.class);
                startActivity(intent);
            }
        });
