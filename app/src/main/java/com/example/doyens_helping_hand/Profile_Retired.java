...
public class Profile_Retired extends AppCompatActivity {
    private Button logout,find;
    private FirebaseUser user;
    private DatabaseReference reference;
    private String userid,mail,email;
    private static final String USERS="RetiredPeople_info";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_retired);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(Profile_Retired.this,MainActivity.class));
            }
        });
        ...
        find.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Profile_Retired.this,cosine_similarity_doyen.class));
            }
        });
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(Profile_Retired.this,"Your profile retrived!!",Toast.LENGTH_LONG).show();
            }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Profile_Retired.this,"Something Wrong Happened!",Toast.LENGTH_LONG).show();
            }
        });
